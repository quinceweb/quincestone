...
function MarketingPath() {
  const steps = [
    ["01", "Discover", "Start with the demand, problem, or opportunity that needs a clearer next step."],
    ["02", "Build", "Shape the experience, product, and operating foundation around what you learned."],
    ["03", "Operate", "Connect interaction to intelligence, policy, workflow, and human judgment."],
    ["04", "Scale", "Use real outcomes to improve the system instead of scaling assumptions."],
  ];
