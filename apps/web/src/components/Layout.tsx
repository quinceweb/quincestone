...
function ShopHeader({ closeAll }: { closeAll: () => void }) {
  return <header className="shop-header">
    ...
    <nav aria-label="Shop navigation" className="shop-nav">
      <NavLink to="/shop/travel">Travel</NavLink><NavLink to="/shop/drive">Drive</NavLink><NavLink to="/shop/companion">Companion</NavLink><NavLink to="/shop/gadgets">Gadgets</NavLink><NavLink to="/shop/home-outdoor">Home + Outdoor</NavLink><a href="/shop#shop-search">Search</a>
    </nav>
