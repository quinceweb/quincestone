...
export function BusinessPage() {
  ...
  function selectScenario(index: number) {
    ...
    setRequest(scenarios[index].request);
    setStageIndex(0);
  }
  ...
  return <main className="business-page">
    ...
    <section className="business-demo" aria-labelledby="business-demo-title">
      ...
      <div className="business-demo__surface">
        ...
        <div className="business-demo__legend"><span>TRACEABLE</span><span>AUTHORITY-AWARE</span><span>DEMONSTRATION</span><span>NO LIVE CUSTOMER DATA</span></div>
      </div>
    </section>
