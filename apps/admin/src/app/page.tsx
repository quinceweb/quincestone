...
/**
 * P18 deliberately has no privileged fallback. Until an independent platform
 * administrator authority is provisioned, the control plane must not expose
 * workspace data or administrative actions.
 */
