...
const pages: Record<string, PageContent> = {
  platform: { eyebrow: "THE PLATFORM", title: "An intelligence layer for digital operations.", intro: "Quincestone connects experience, controlled AI, business knowledge, qualification, routing, escalation, and visibility.", sections: [
    { title: "Observe", text: "Capture consented interaction signals and declared context at the edge." }, { title: "Interpret", text: "Combine deterministic logic, approved knowledge, and bounded AI." }, { title: "Route", text: "Move each interaction into the correct workflow with an explainable decision record." }] },
  ...
  demo: { eyebrow: "LIVE PRODUCT DEMONSTRATION", title: "Watch interaction become action.", intro: "Use a deterministic fictional roofing journey, then inspect how Quincestone explains and routes the interaction.", sections: [
    { title: "Visitor experience", text: "Walk through intent, context, qualification, appointment, and confirmation." }, { title: "Operations console", text: "Search fictional records, inspect policy decisions, and advance a simulated workflow." }] },
